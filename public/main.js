...
var createRoom = function(){
  ...
  document.getElementsByClassName('spotifySignIn')[0].style.display = "initial";
...
var createPlaylist = function(){
  ...
  document.getElementsByClassName('spotifySignIn')[0].remove();
...
function green()
{document.getElementsByClassName('spotifySignIn')[0].className += ' spotifyGreen';}
...
var access = '';
 (function() {
  ...
  var spotifyApi = new SpotifyWebApi();
   var accessToken;
    firebase.database().ref().child("spotifyAccessToken/spotify:12165475015").once('value').then(function(snapshot) {
      console.log(snapshot.val());
...
function predict(i){
      ...
      var aco = returnTest[0].Acousticness
      var children = document.getElementById('icon' + i)
